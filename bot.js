...
اسم البوت
bot arab : هنا
bot link : https://discordapp.com/api/oauth2/authorize?client_id=504399655258423315&permissions=8&scope=bot
`);
...
client.on('message', message => {
 var prefix = "++"
    if(message.content.startsWith(prefix + 'new')) {
        let args = message.content.split(' ').slice(1).join(' ');
        let support = message.guild.roles.find("name","bot arab");
